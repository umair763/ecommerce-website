                                ...
                                if (($(this._element).trigger(i), !i.isDefaultPrevented())) {
                                    ...
                                    $(this._element).removeClass(lt).addClass(ct),
                                        (this._element.style[r] = 0) < this._triggerArray.length &&
                                            $(this._triggerArray).removeClass(ft).attr('aria-expanded', !0),
            ...
            modifiers: {
                ...
                applyStyle: {
                    ...
                    onLoad: function (t, e, n, i, r) {
                        ...
                        return (
                            e.setAttribute('x-placement', s), se(e, { position: n.positionFixed ? 'fixed' : 'absolute' }), n
                        );
                    },
                                    ...
                                    if (
                                        ...
                                        ge(i).trigger(a),
                                            a.isDefaultPrevented() ||
                                                ('ontouchstart' in document.documentElement &&
                                                    ge(document.body).children().off('mouseover', null, ge.noop),
